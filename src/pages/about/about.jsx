...
// import LoadingButton from "../../../components/load-btn/load-btn"; // Assuming you're importing a custom component for a loading button
        ...
        <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
          <div className="col-12 col-lg-6">
            <img
              ...
              loading="lazy"
              src="https://images.pexels.com/photos/3379937/pexels-photo-3379937.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
              alt=""
            />
          </div>
          <div className="col-12 col-lg-6">
